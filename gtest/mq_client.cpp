...
{  
	...
	// head
	cout << "pmessage.head().session_no()" << pmessage.head().session_no() << endl;
	cout << "pmessage.head().message_type()" << pmessage.head().message_type() << endl;
	cout << "pmessage.head().client_ip()" << pmessage.head().client_ip() << endl;
	cout << "pmessage.head().target_ip()" << pmessage.head().target_ip() << endl;
	cout << "pmessage.head().target_port()" << pmessage.head().target_port() << endl;
*/
    ...
    //body
	cout << "rmessage.body().GetExtension(just_test_response).test_id()" << endl;
